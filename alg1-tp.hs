...
secuenciasDeFibonacciDeLongitudK :: Tablero -> Integer -> Conjunto Camino
secuenciasDeFibonacciDeLongitudK t k = eliminarRepetidosCamino (permutarCaminosKLista k (descartaLasMenores k (todosLosFibonacci t)))
